<div align="center">
	<h2>My porfolio website was built by using kross-jekyll-portfolio-template</h2>
	<h2>I would like to say "Thank you so much for this magnificant Jekyll template, Themefisher"</h2>	
</div>
